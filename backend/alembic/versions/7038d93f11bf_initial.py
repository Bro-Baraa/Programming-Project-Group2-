...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['profile_id'], ['competency_profiles.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['competency_profile_id'], ['competency_profiles.id'], ),
    sa.ForeignKeyConstraint(['mentor_id'], ['users.id'], ),
    ...
    sa.CheckConstraint('score IS NULL OR (score >= 1 AND score <= 5)', name='ck_evaluation_rule_score_range'),
    sa.ForeignKeyConstraint(['competency_id'], ['competencies.id'], ),
    sa.ForeignKeyConstraint(['evaluation_id'], ['evaluations.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_evaluation_rules_id'), 'evaluation_rules', ['id'], unique=False)
