...
class TestCompetencyUpdate:
    ...
    def test_admin_update_competency(self, client, auth_headers_admin, sample_competencies):
    ...
    def test_non_admin_cannot_update(self, client, auth_headers_teacher, sample_competencies):
