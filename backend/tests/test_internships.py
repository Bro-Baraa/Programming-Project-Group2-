...
class TestInternshipCreation:
    ...
    def test_student_create_internship(
        ...
        response = client.post(
            "/api/internships", json=internship_data, headers=auth_headers_student
        )
    ...
    def test_student_create_internship_with_supervisors(
    ...
    def test_student_create_internship_with_invalid_teacher(
    ...
    def test_teacher_cannot_create_internship(self, client, auth_headers_teacher):
        ...
        response = client.post(
            "/api/internships", json=internship_data, headers=auth_headers_teacher
        )
...
class TestInternshipListing:
    ...
    def test_student_sees_own_internships(
        self, client, auth_headers_student, sample_internships, test_student
    ):
    ...
    def test_committee_sees_all_internships(
        self, client, auth_headers_committee, sample_internships
    ):
    ...
    def test_filter_by_status(self, client, auth_headers_committee, sample_internships):
        ...
        response = client.get(
            "/api/internships?status=Ingediend", headers=auth_headers_committee
        )
        assert response.status_code == 200
        data = response.json()
        assert len(data) == 1
...
class TestInternshipWorkflow:
    ...
    def test_status_transition_via_proposal(
        self, client, auth_headers_committee, created_internship, test_teacher
    ):
        ...
        internship_response = client.get(
            f"/api/internships/{internship_id}", headers=auth_headers_committee
        )
        assert internship_response.status_code == 200
        assert internship_response.json()["status"] == "Goedgekeurd"

    def test_proposal_requires_feedback_for_changes(
        self, client, auth_headers_committee, created_internship
    ):
    ...
    def test_student_cannot_approve_proposal(
        self, client, auth_headers_student, created_internship
    ):
    ...
    def test_agreement_workflow_transitions_status(
        self,
        client,
        auth_headers_student,
        auth_headers_committee,
        created_internship,
        test_teacher,
    ):
        ...
        response = client.post(
            ...
            files={
                "file": ("agreement.pdf", io.BytesIO(pdf_content), "application/pdf")
            },
            headers=auth_headers_student,
        )
        assert response.status_code == 200
    ...
    def test_get_internship_detail(
        ...
        response = client.get(
            f"/api/internships/{internship_id}", headers=auth_headers_student
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_student_can_edit_proposal_before_review(
        self, client, auth_headers_student, created_internship
    ):
    ...
    def test_student_cannot_edit_proposal_after_review(
        self, client, auth_headers_student, auth_headers_committee, created_internship
    ):
    ...
    def test_student_can_withdraw_proposal(
        self, client, auth_headers_student, created_internship
    ):
        ...
        response = client.delete(
            f"/api/internships/{internship_id}/proposal", headers=auth_headers_student
        )
        assert response.status_code == 200
    ...
    def test_student_cannot_withdraw_after_review(
        self, client, auth_headers_student, auth_headers_committee, created_internship
    ):
    ...
    def test_feedback_cleared_on_resubmit(
        self, client, auth_headers_student, auth_headers_committee, created_internship
    ):
    ...
    def test_revision_count_on_resubmit(
        self, client, auth_headers_student, auth_headers_committee, created_internship
    ):
...
class TestLogbooks:
    ...
    def test_create_logbook(
        self, client, auth_headers_student, internship_with_logbook
    ):
    ...
    def test_duplicate_week_rejected(
        self, client, auth_headers_student, internship_with_logbook
    ):
    ...
    def test_mentor_validates_logbook(
        self,
        client,
        auth_headers_student,
        auth_headers_mentor,
        internship_with_logbook,
        db,
    ):
    ...
    def test_mentor_can_give_feedback(
        self, client, auth_headers_mentor, internship_with_logbook, db
    ):
    ...
    def test_student_can_submit_logbook(
        self, client, auth_headers_student, internship_with_logbook, db
    ):
    ...
    def test_non_student_cannot_submit_logbook(
        self, client, auth_headers_mentor, internship_with_logbook, db
    ):
    ...
    def test_cannot_submit_already_submitted_logbook(
        self, client, auth_headers_student, internship_with_logbook, db
    ):
...
class TestDashboardStats:
    ...
    def test_dashboard_stats(self, client, auth_headers_admin, db, test_student):
        ...
        response = client.get(
            "/api/internships/stats/dashboard", headers=auth_headers_admin
        )
        assert response.status_code == 200
        data = response.json()
...
class TestFeedback:
    ...
    def test_create_feedback(
        ...
        feedback_data = {"message": "Great progress!", "to_user_id": test_student.id}
...
class TestEvaluations:
    ...
    def created_evaluation(
        self, client, auth_headers_teacher, sample_internship, sample_competencies
    ):
        ...
        ), f"Failed to create evaluation: {response.text}"
        return response.json()

    def test_update_evaluation_rule(
        ...
        update_data = {"score": 4, "evaluator_feedback": "Good work on this competency"}
    ...
    def test_cannot_update_finalized_evaluation(
        self, client, auth_headers_teacher, created_evaluation, db
    ):
    ...
    def test_finalize_evaluation(
        self, client, auth_headers_teacher, created_evaluation, test_teacher, db
    ):
    ...
    def test_student_cannot_finalize(
        self, client, auth_headers_student, created_evaluation
    ):
    ...
    def test_student_can_update_own_description(
        self, client, auth_headers_student, created_evaluation, db
    ):
        ...
        assert (
            ...
            == "I learned how to build REST APIs during this week"
        )

    def test_student_cannot_update_score_or_feedback(
        self, client, auth_headers_student, created_evaluation, db
    ):
    ...
    def test_student_cannot_update_other_student_rule(
        self, client, auth_headers_student, created_evaluation, db
    ):
    ...
    def test_student_cannot_update_finalized_rule(
        self, client, auth_headers_student, auth_headers_teacher, created_evaluation, db
    ):
    ...
    def test_student_cannot_set_evaluator_feedback(
        self, client, auth_headers_student, created_evaluation, db
    ):
        ...
        response = client.patch(
            f"/api/internships/evaluations/{evaluation_id}/rules/{rule.id}",
            json={
                "evaluator_feedback": "Self-praise",
                "student_description": "Valid description",
            },
            headers=auth_headers_student,
        )
        assert response.status_code == 200
    ...
    def test_teacher_cannot_set_student_description(
        self, client, auth_headers_teacher, created_evaluation, db
    ):
